...
public final class ApiPaths {
    ...
    public static final class Security {
        ...
        // Admin write patterns
        public static final String ADMIN_CREATE_USER_POST = ApiPaths.Admin.BASE + ApiPaths.Admin.CREATE_USER;
        public static final String ADMIN_LOCK_USER_POST = ApiPaths.Admin.BASE + ApiPaths.Admin.LOCK_USER + "/**";
        public static final String ADMIN_UNLOCK_USER_POST = ApiPaths.Admin.BASE + ApiPaths.Admin.UNLOCK_USER + "/**";
        public static final String ADMIN_UPDATE_ROLE_PUT = ApiPaths.Admin.BASE + ApiPaths.Admin.UPDATE_ROLE;
        public static final String ADMIN_UPDATE_USER_PUT = ApiPaths.Admin.BASE + ApiPaths.Admin.UPDATE_USER + "/**";
        public static final String ADMIN_DELETE_USER_DELETE = ApiPaths.Admin.BASE + ApiPaths.Admin.DELETE_USER + "/**";

        // Audit pattern
        public static final String AUDIT_PATTERN = ApiPaths.Audit.BASE + "/**";

        // =====================================================
        // Aliases legacy (compatibilidad con SecurityConfig)
        // =====================================================
        ...
        /** POST /api/v1/admin/lock-user/{email} */
        public static final String ADMIN_LOCK_USER_PATTERN = ADMIN_LOCK_USER_POST;

        /** POST /api/v1/admin/unlock/{email} */
        public static final String ADMIN_UNLOCK_USER_PATTERN = ADMIN_UNLOCK_USER_POST;

        /** POST /api/v1/admin/create-user */
        public static final String ADMIN_CREATE_USER = ADMIN_CREATE_USER_POST;

        /** PUT /api/v1/admin/update-user/{id} */
        public static final String ADMIN_UPDATE_USER_PATTERN = ADMIN_UPDATE_USER_PUT;

        /** PUT /api/v1/admin/update-role */
        public static final String ADMIN_UPDATE_ROLE = ADMIN_UPDATE_ROLE_PUT;

        /** DELETE /api/v1/admin/delete/{id} */
        public static final String ADMIN_DELETE_USER_PATTERN = ADMIN_DELETE_USER_DELETE;
